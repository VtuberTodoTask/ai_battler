...
export const TAVERN_REQUEST_TEMPLATES: TavernRequestTemplate[] = [
  ...
  {
    id: 'survey-flooded-road-damage',
    objectiveType: 'survey',
    title: '増水した街道の被害測量',
    environment: 'plains',
    briefing: '長雨による増水で寸断された街道の被害状況を測量する。',
  ...
  {
    id: 'rescue-stranded-travelers',
    objectiveType: 'rescue',
    title: '取り残された旅人の救助',
    environment: 'plains',
    briefing: '増水した街道で孤立し取り残された旅人を救助する。',
  ...
  {
    id: 'escort-flood-detour-caravan',
    objectiveType: 'escort',
    title: '迂回路を通る隊商の護衛',
    environment: 'plains',
    briefing: '増水で寸断された街道を避け、迂回路を進む隊商を護衛する。',
  ...
  {
    id: 'survey-exposed-ruins',
    objectiveType: 'survey',
    title: '露出した遺構の安全測量',
    environment: 'ruins',
    briefing: '崩落で露出した未知の遺構内部の安全性と構造を測量する。',
  ...
  {
    id: 'investigation-missing-caravans',
    objectiveType: 'investigation',
    title: '途絶えた隊商の足取り調査',
    environment: 'plains',
    briefing: '予定どおり到着しない隊商の足取りと原因を調査する。',
    features: ['ambushRisk', 'poorVisibility'],
    publicTags: ['調査', '街道', '隊商'],
    battleChance: 25,
    build({ requestId, seed, rank, battleEnabled }) {
        ...
        ...baseRequest(
          ...
          [
            ...
            },
            {
              id: 'info-2',
              name: '落とし荷',
              description: '慌てて落とされた積荷',
              difficulty: 15,
            },
            {
              id: 'info-3',
              name: '争った形跡',
              description: '何かに襲われた痕跡',
              difficulty: 20,
              requiredSkill: 'monsterKnowledge',
            },
          ],
