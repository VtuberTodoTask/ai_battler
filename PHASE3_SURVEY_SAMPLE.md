...
- contact: surveySectorResult / 北区画について不完全ながら測量記録を取得した。測量精度は55だった
- objective: surveySectorResult / 中央区画の測量を完了できなかった
- objective: surveySectorResult / 南区画の測量を完了した。測量精度は80だった
- return: surveyReportPrepared / 2区画分の測量記録を整理し、持ち帰る準備を行った
- return: travel / エルナ エルウィンが経路を確保したが、多少の遅延が発生した
- return: surveyReportReturned / 測量記録を酒場まで持ち帰った
- aftermath: surveyCompleted / 測量地域の測量進捗: 75% (2/3区画, 平均精度68)
- **survey effects**: surveyAreaAssigned=1, surveyCoverage=0, surveyAverageQuality=0, surveySurveyedSectorCount=0, surveyReportPrepared=0, surveyReportReturned=0, surveyProgress=0, surveySectorSurveyed=1, surveySectorQuality=55, surveySectorResult=55, surveyCoverage=33.33333333333333, surveyAverageQuality=55, surveySurveyedSectorCount=1, surveyProgress=25, surveySectorSurveyed=0, surveySectorQuality=0, surveySectorResult=0, surveyCoverage=33.33333333333333, surveyAverageQuality=55, surveySurveyedSectorCount=1, surveyProgress=25, surveySectorSurveyed=1, surveySectorQuality=80, surveySectorResult=80, surveyCoverage=66.66666666666666, surveyAverageQuality=67.5, surveySurveyedSectorCount=2, surveyProgress=50, surveyReportPrepared=1, surveyCoverage=66.66666666666666, surveyAverageQuality=67.5, surveySurveyedSectorCount=2, surveyProgress=50, surveyReportReturned=1, surveyProgress=75, surveyCoverage=66.66666666666666, surveyAverageQuality=67.5, surveyProgress=75, surveyCompleted=0

---

## ケース C: partialSuccess: 全3区画を測量したが要求品質を下回った
...
- **主要ログ**:
- preparation: surveyAreaAssigned / 「測量地域」の3区画を測量する任務を開始した
- approach: travel / トール スカイが接近経路を見失い、迂回した
...
- return: travel / トール スカイが安全な帰還経路を確保した
- aftermath: surveyCompleted / 測量地域の測量進捗: 0% (0/3区画, 平均精度0)
...
## ケース E: forcedRetreat: 戦闘で敗退し測量を中止
...
- **surveyAreaAssigned structured metadata**:
  ...
  - areaName: 測量地域
  - minimumAcceptableQuality: 70
  - sectors: [{"id":"north","name":"北区画","focus":"route","difficulty":1000},{"id":"center","name":"中央区画","focus":"terrain","difficulty":0},{"id":"south","name":"南区画","focus":"arcane","difficulty":0}]
- **主要ログ**:
- preparation: surveyAreaAssigned / 「測量地域」の3区画を測量する任務を開始した
- approach: travel / マルチナ リバーが安全な接近経路を確保した
- contact: surveySectorResult / 北区画の測量を完了できなかった
- return: surveyReportPrepared / 測量記録を作成できなかった
- return: travel / ハロルド ヴァレスが経路を確保したが、多少の遅延が発生した
- aftermath: surveyCompleted / 測量地域の測量進捗: 0% (0/3区画, 平均精度0)
- **survey effects**: surveyAreaAssigned=1, surveyCoverage=0, surveyAverageQuality=0, surveySurveyedSectorCount=0, surveyReportPrepared=0, surveyReportReturned=0, surveyProgress=0, surveySectorSurveyed=0, surveySectorQuality=0, surveySectorResult=0, surveyCoverage=0, surveyAverageQuality=0, surveySurveyedSectorCount=0, surveyProgress=0, surveyReportPrepared=0, surveyCoverage=0, surveyAverageQuality=0, surveySurveyedSectorCount=0, surveyProgress=0, surveyCoverage=0, surveyAverageQuality=0, surveyProgress=0, surveyCompleted=0
